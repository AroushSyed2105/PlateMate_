...
//                "Nutritional Summary", // Title text
...
//        titleBorder.setTitleFont(new Font("Times New Roman", Font.BOLD, 18)); // Set font size and style
//        titleBorder.setTitleColor(new Color(0, 0, 0)); // Set font color (green, or any color you like)
//
